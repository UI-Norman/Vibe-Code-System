...
# Current project root (will be set dynamically)
PROJECT_ROOT = PROJECTS_BASE / "default"


def set_project_folder(folder_name: str):
    """Set the current project folder."""
    global PROJECT_ROOT
    PROJECT_ROOT = PROJECTS_BASE / folder_name
    PROJECT_ROOT.mkdir(parents=True, exist_ok=True)
    print(f"📁 Project folder set to: {PROJECT_ROOT}")
